...
run python3 scripts/set-version.py "$version"
run env PYTHONPYCACHEPREFIX="${TMPDIR:-/tmp}/csdb-python-pycache" python3 -m compileall src
run git add pyproject.toml src/csdb/__init__.py
